...
// TODO: have claude make the skeletong look better
// The card flashes an empty state, then shows completed. that is not ideal
// The cards do the same thing with the completd state flashong after load
// make a skeletong loader for the HabitCardDetialed
